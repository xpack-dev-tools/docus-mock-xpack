...
<pre>
C:\>%USERPROFILE%\AppData\Roaming\xPacks\@xpack-dev-tools\ninja-build\{ frontMatter.version }-{ frontMatter.xpack_subversion }.1\.content\bin\ninja.exe --version
{ frontMatter.version }
</pre>
...
<ul>
<li><code>xpack-ninja-build-{ frontMatter.version }-{ frontMatter.xpack_subversion }-win32-x64.zip</code></li>
</ul>
...
<pre>
C:\>%USERPROFILE%\AppData\Roaming\xPacks\ninja-build\xpack-ninja-{ frontMatter.version }-{ frontMatter.xpack_subversion }\bin\ninja.exe --version
{ frontMatter.version }
</pre>
